...
import cv.com.materialtoast.Toast.AchievementUnlocked;


public class ToastMainActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        switch (i) {
            case 0:
                ...
                break;
            case 1:
                new AchievementUnlocked(this).setTitle("Transhumanist").setSubTitle("Augmented").setIcon(getDrawableFromRes(R.drawable.mario)).setBackgroundDrawable(getDrawableFromRes(R.drawable.custom_bg)).isLarge(true).build().show();
                break;
            case 2:
                new AchievementUnlocked(this).setTitle("Pacifist").setSubTitle("They don't deserve death").setIcon(getDrawableFromRes(R.drawable.monster)).isRounded(false).isLarge(false).alignTop(false).build().show();
                break;
            case 3:
